...
<?php
    ...
    */
    ...
    echo "<h2>Esta es otra fila de la clase de ".$NombreClase." con dos cadenas conectadas </h2>";
    echo "</body>";
    echo "</html>";
    ...
    echo "<p>Este es un nombre de variable extraido de una cadena ".$$varibleNombreClase."</p>";
?>
